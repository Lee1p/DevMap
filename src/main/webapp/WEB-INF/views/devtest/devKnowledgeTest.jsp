        ...
        <main class="app-main">
            <div class="form-container">
                <div class="form-box">
                    ...
                    <form action="<%=request.getContextPath()%>/devtest/DevFieldSelection.do" method="POST">
                        <p class="question">
                            <b>Q. "문제를 풀어주세요."</b>
                        </p>
                        <p class="question">
                        ...
                        <!-- 개발 분야 리스트를 EL로 출력 -->
                        <div class="dev-field-list">
                            <c:forEach var="devField" items="${devFields}">
                                <button type="button" name="field" value="${devField.fieldSeq}">
                                    ${devField.fieldName}
                                </button>
                            </c:forEach>
                        </div>
                        ...
                        <div class="form-buttons">
                            <button type="button" id="back" class="button-back" onclick="history.back();">뒤로가기</button>
